package com.example.myapplication.eventcalender.helpers
...
import com.example.myapplication.eventcalender.extenstion.isTsOnProperDay
import com.example.myapplication.eventcalender.extenstion.isXWeeklyRepetition
...
/*
    ...
    fun getEventsSync(
        ...
        events.forEach {
            ...
            it.color = eventTypeColors.get(it.eventType) ?: ContextCompat.getColor(context, R.color.colorPrimary)
        }
    ...
    fun getRepeatableEventsFor(
        ...
        events.add(Event(1).apply {
            startTS = Formatter.getDateTimeFromCode("20190201").seconds()
            endTS = Formatter.getDateTimeFromCode("20190215").seconds()
            title = "First Event"
            description = ""
      ...
      events.add(Event(2).apply {
            startTS = Formatter.getDateTimeFromCode("20190202").seconds()
            endTS = Formatter.getDateTimeFromCode("20190210").seconds()
            title = "Second Event"
            description = ""
            color = ContextCompat.getColor(context, R.color.colorAccent)
            //flags = mEvent.flags.addBitIf(event_all_day.isChecked, FLAG_ALL_DAY)
        ...
        events.add(Event(3).apply {
            startTS = Formatter.getDateTimeFromCode("20190205").seconds()
            endTS = Formatter.getDateTimeFromCode("20190211").seconds()
            title = "Third Event"
            description = ""
            color = ContextCompat.getColor(context, R.color.colorAccent)
            //flags = mEvent.flags.addBitIf(event_all_day.isChecked, FLAG_ALL_DAY)
        ...
        events.add(Event(6).apply {
            startTS = Formatter.getDateTimeFromCode("20190210").seconds()
            endTS = Formatter.getDateTimeFromCode("20190212").seconds()
            title = "Last  Event"
            description = ""
            color = ContextCompat.getColor(context, R.color.colorAccent)
            //flags = mEvent.flags.addBitIf(event_all_day.isChecked, FLAG_ALL_DAY)
