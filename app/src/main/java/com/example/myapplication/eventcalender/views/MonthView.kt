package com.example.myapplication.eventcalender.views
...
import com.example.myapplication.eventcalender.extenstion.adjustAlpha
import com.example.myapplication.eventcalender.extenstion.getContrastColor
...
import com.example.myapplication.eventcalender.models.MonthViewEvent
...
class MonthView(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
    ...
    init {
        ...
        gridPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = textColor.adjustAlpha(.3f)
        }
